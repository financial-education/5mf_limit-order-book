...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 56 }, { marker: 'pandoc', elapsed: 124 }, { marker: 'post-processor', elapsed: 1 }, { marker: 'pre-processor', elapsed: 4 }, { marker: 'render', elapsed: 376 } ];
